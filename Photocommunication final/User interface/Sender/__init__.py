...
#defining the version of the project and the programmers
pip.__version__ = 1.0
...
def main():
    ...
    #checking whether the program is in debug mode or not
    if parser.get("default", "debug") == '1':
        logging.getLogger().setLevel(logging.DEBUG)
    if parser.get("default", "debug") == '0':
        logging.getLogger().setLevel(logging.INFO)

    #searching for all the available com ports
...
#run main function only if this is the program executed
